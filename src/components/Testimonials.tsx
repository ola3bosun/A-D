...
export default function VoicesOfChange() {
  return (
    ...
    <section className="w-full bg-[#F5F3E9] pt-24 pb-32 md:pt-32 relative">
      ...
      {/* pb-[30vh] ensures enough scroll room at the bottom for the last card */}
      <div className="max-w-4xl mx-auto px-6 pb-[30vh]">
        {reviews.map((review, i) => (
          <div
            ...
            style={{ 
              // EXACT SAME TOP VALUE FOR EVERY CARD. This makes them stack perfectly flush.
              top: '120px',
              // zIndex ensures the newer cards always render cleanly on top of older ones
              zIndex: i + 10 
            }}
          >
